        ...
        <div class="my-3 mx-5 d-flex flex-row flex-wrap is-centered justify-content-around">
            <div class="card text-white m-3 shadow border-primary">
                <div class="card-header bg-primary">
                    ...
                    <h5><i class="fas fa-solid fa-crown"></i> Manager</h5>
                </div>
            ...
            ${employees.map(employee => {
                if(employee.getRole() === "Intern") {
                     ...
                     <div class="card-header bg-primary">
                         <h3>${employee.name}</h3>
                         <h5><i class="fas fa-solid fa-graduation-cap"></i> Intern</h5>
                     </div>
                     <div class="card-body bg-info bg-opacity-10">
                         <div class=" py-3">
                             <ul class="list-group list-group-flush">
                 ...
                 if(employee.getRole() === "Engineer") {
                     ...
                     <div class="card-header bg-primary">
                         <h3>${employee.name}</h3>
                         <h5><i class="fas fa-solid fa-lightbulb"></i> Engineer</h5>
                     </div>
                     <div class="card-body bg-info bg-opacity-10">
                         <div class=" py-3">
                             <ul class="list-group list-group-flush">
